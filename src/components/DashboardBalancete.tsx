  ...
  const structureIndicators: IndicatorConfig[] = [
    {
      ...
      formulaDescription: "Soma de todos os bens e direitos da empresa extraídos do balancete. A memória de cálculo abaixo detalha as contas analíticas, incluindo imobilizado e suas redutoras.",
      accounts: [
        ...accountsForGrupos(entries, ["DISPONIBILIDADES", "CAIXA", "BANCO", "CONTAS_A_RECEBER", "CLIENTES", "ESTOQUE", "ATIVO_CIRCULANTE", "APLICAC"]),
        { descricao: "─── Ativo Não Circulante ───", valor: 0, motivo: "" },
        ...accountsForGrupos(entries, ["ATIVO_NAO_CIRCULANTE", "IMOBILIZADO", "INTANGIVEL", "INVESTIMENTO", "REALIZAVEL"]),
      ],
    },
    {
      title: "Passivo Total",
